...
MOSAIC or **M**ulti-**O**mics **S**upervised **I**ntegrative **C**lustering is in its beta phase. 
...
_MOSAIC_ is a multi-omic supervised clustering algorithm led by outcome of interest. This methodology is inspired from [survClust](https://github.com/arorarshi/survClust)
